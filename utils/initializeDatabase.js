...
const initializeDatabase = async () =>
{
    ...
    const createPostTableQuery = "CREATE TABLE IF NOT EXISTS PostService.Post(postID INT PRIMARY KEY AUTO_INCREMENT, title TEXT, description TEXT, createdAt DATETIME, updatedAt DATETIME,isAnonymous INT);"
